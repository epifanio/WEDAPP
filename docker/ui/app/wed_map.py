...
def getMap():
    ...
    gmap_retiro = f"""<a href="{gmap_url_black_jack}" target="_blank"> C. de Trujillos, 7, Centro, 28013 Madrid </a>"""
    gmap_restaurant = f"""<a href="{gmap_restaurant_url}" target="_blank"> C. de Serrano, 95, Chamartín, 28006 Madrid </a>"""
    gmap_casa_sposi = f"""<a href="{gmap_url_casa_sposi}" target="_blank"> C. de Francisco Silvela, 27, 6 C 28028 Madrid </a>"""
    gmap_black_jack = f"""<a href="{gmap_retiro_url}" target="_blank"> Pl. de Daoíz y Velarde, 2, Retiro, 28007 Madrid </a>"""
    ...
    attributes = [
        ...
        {"name": "Casa Sposi", "description": f"<b>Casa Sposi </b> <br>{gmap_casa_sposi}"}
    ]
...
def location_description(lang='en'):
    ...
    gmap_url_casa_sposi = "https://www.google.com/maps/place/C%2F+de+Francisco+Silvela,+27,+6+c,+Salamanca,+28028+Madrid/@40.4313076,-3.6744468,17z/data=!3m1!4b1!4m5!3m4!1s0xd4228b77a09fc2d:0x69b75571be49d39!8m2!3d40.4313035!4d-3.6718719?entry=ttu"
    gmap_url_black_jack = "https://www.google.com/maps/place/Black+Jack+Club/@40.4187465,-3.7101133,17z/data=!3m1!4b1!4m6!3m5!1s0xd4229d71079ac6d:0x1a27a5ce4dada59b!8m2!3d40.4187424!4d-3.7075384!16s%2Fg%2F11kqq9rdk9?entry=ttu"
    gmap_retiro = f"""<a href="{gmap_retiro_url}" target="_blank"> C. de Trujillos, 7, Centro, 28013 Madrid </a>"""
    gmap_restaurant = f"""<a href="{gmap_restaurant_url}" target="_blank"> C. de Serrano, 95, Chamartín, 28006 Madrid </a>"""
    gmap_casa_sposi = f"""<a href="{gmap_url_casa_sposi}" target="_blank"> C. de Francisco Silvela, 27, 6 C, 28028 Madrid </a>"""
    gmap_black_jack = f"""<a href="{gmap_url_black_jack}" target="_blank"> Pl. de Daoíz y Velarde, 2, Retiro, 28007 Madrid </a>"""
    
    retiro_description = f""" <p style="font-family:'Courier New'; font-size:20px;"><b>{cerimony} </b> <br> {gmap_retiro}</p>"""
    restaurant_description = f""" <p style="font-family:'Courier New'; font-size:20px;"><b>{restaurant}</b> <br> {gmap_restaurant}</p>"""
    casa_sposi_description = f""" <p style="font-family:'Courier New'; font-size:20px;"><b>{casa_sposi}</b> <br>{gmap_casa_sposi}</p>"""
    black_jack_description = f"""<p style="font-family:'Courier New'; font-size:20px;"><b>{party_post_boda}</b> <br> {gmap_black_jack}</p>"""
